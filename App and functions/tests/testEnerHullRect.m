function tests = testEnerHullRect
...
function testPerfectFit(testCase)
    ...
    coor = [1, 0.5, 0];  % Center at (1, 0.5) and 0 rotation
    cent = [0,0;0,1;2,1;2,0]; % Locations of particles
    cutoff = 0.25;
    
    % Call the function directly
    e = enerHullRect(app,coor,cutoff,cent,hu);

    % Expected energy
    expectedEnergy=-4*cutoff^2;
...
function testStretchedBond(testCase)
    ...
    hu = [2, 1]; % Hull parameters [a, b]
    coor = [1, 0.5, 0];  % Center at (1, 0.5) and 0 rotation
    cent = [0,0;0.1,1;2,1;2,0]; % Locations of particles
    cutoff = 0.25;
    ...
    % Expected energy
    expectedEnergy=-4*cutoff^2+0.01;
...
function testBrokenBond(testCase)
   ...
   % Define test inputs
    hu = [2, 1]; % Hull parameters [a, b]
    coor = [1, 0.5, 0];  % Center at (1, 0.5) and 0 rotation
    cent = [0,0;0.3,1;2,1;2,0]; % Locations of particles
    cutoff = 0.25;
