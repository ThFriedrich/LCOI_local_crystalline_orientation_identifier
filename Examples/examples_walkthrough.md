...
This file provides a walkthrough guide for the crystal's directionality analysis of the three attached example files. This is not a full guide for the use of the application but rather a list of suggested parameters for the analysis of the examples and the results expected from these routines. For a more thorough guide on how to use the app see the attached user manual.
